"""Joint analysis for HoGLTF IR files.
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Jointly inspect HoGLTF material and object/scene IR JSON files.")
    parser.add_argument(
        "--material",
        action="append",
        default=[],
